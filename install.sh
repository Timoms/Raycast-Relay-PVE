...
msg_info "Access ${APP_NAME} using the following URL: http://${IP}:${PORT}/health"
msg_info "You can edit the .dev.vars file at /opt/${APP_NAME_LINUX}/.dev.vars to update your credentials and settings."
msg_info "Visit the official repository for more information:"
msg_info "https://github.com/szcharlesji/raycast-relay"
